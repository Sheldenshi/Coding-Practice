...
Problem explanation (Problems from HackerRank will be in a pdf in that problem's directory).
...
# Testing #
###########
(HackerRank problems have input and output directories.)
# Test 1
